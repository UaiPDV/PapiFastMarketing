...
export const Business: React.FC = () => {
	...
	const getImageSrc = (src?: string) =>
		...
		src ||
		'https://placehold.co/600x400/111/fff?text=Preview';
			...
			<section className="relative overflow-hidden pt-16 pb-24 lg:pt-32 lg:pb-40 text-center">
				...
				<div className="max-w-7xl mx-auto px-4">
					...
					<div className="flex flex-col sm:flex-row justify-center gap-4">
						<button className="accent px-8 py-3 rounded-xl font-bold shadow-lg transition hover:scale-105">
							{data.hero.cta_button}
						</button>
						<button className="bg-white/10 px-8 py-3 rounded-xl font-bold hover:bg-white/15 transition hover:scale-105 border border-white/10">
