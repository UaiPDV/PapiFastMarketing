...
export const Home: React.FC = () => {
	...
	const aboutImages =
		data.about.images || (data.about.image ? [data.about.image] : []);
		...
		<div className="flex flex-col">
				...
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					<div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
						<div className="text-center lg:text-left reveal">
							...
							<div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
								...
								<button
									...
									className="px-8 py-3 rounded-xl bg-white/10 hover:bg-white/15 transition hover:scale-105 border border-white/10"
								>
						...
						<div className="relative mt-12 lg:mt-0 h-80 sm:h-96 reveal">
							...
							<img
								src={
									data.hero.image_left ||
									'https://placehold.co/400x800/222/fff?text=App+Left'
								}
							...
							<img
								src={
									data.hero.image_right ||
									'https://placehold.co/400x800/333/fff?text=App+Right'
								}
							...
							{aboutImages.length > 0 ? (
								aboutImages.map((img: string, idx: number) => {
									...
									return (
										<div
											key={idx}
											className={`absolute transition-all duration-500 hover:scale-110 hover:z-50 hover:rotate-0 group cursor-pointer ${
												idx >= 4 ? 'hidden' : ''
											} ${idx === 0 ? 'relative' : pos}`}
											style={{
										...
										>
											<div
												className={`p-2 bg-white shadow-2xl transform ${rot} transition-transform duration-500 group-hover:rotate-0`}
											>
			...
			>
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					...
					<div
						className={`grid ${
							data.howItWorks.image ? 'lg:grid-cols-2' : ''
						} gap-12 items-center`}
					>
						{/* Image if exists */}
							...
							<button
								...
								className={`flex-1 px-6 py-2.5 rounded-lg font-medium transition-all duration-300 ${
									activeTab === idx
										...
										: 'hover:bg-white/5 text-white/70 tab-inactive'
								}`}
							>
								{tab.title}
							</button>
			...
			<section id="contact" className="py-16 border-t border-white/10">
				<div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
					<div className="glass rounded-3xl p-8 md:p-12 text-center md:text-left flex flex-col md:flex-row items-center justify-between gap-8 border border-white/10 bg-gradient-to-br from-white/5 to-transparent">
						...
						<a
							href="https://printweb.vlks.com.br"
							target="_blank"
							rel="noopener noreferrer"
							className="accent px-8 py-4 rounded-xl font-bold shadow-lg whitespace-nowrap text-lg transition hover:scale-105"
						>
							{data.contact.button}
						</a>
					</div>
