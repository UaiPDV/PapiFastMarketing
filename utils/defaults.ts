export const defaultContent = {
	homePage: {
		hero: {
			...
			image_center:
				'https://placehold.co/400x800/444/fff?text=App+Center',
		},
		about: {
			title: 'O jeito moderno de organizar suas comemorações',
			description:
				'O PapiFast é o aplicativo que simplifica a organização de festas, aniversários e eventos especiais. Em poucos cliques, você cria seu evento, adiciona produtos ou presentes, envia convites personalizados e acompanha tudo em tempo real.',
			images: [
		...
		flowsConfig: {
			title: 'Nossos Fluxos',
			subtitle:
				'Ciclos simples para organizar seu evento sem complicações.',
		},
		flows: [
			{
		...
		features: {
			...
			items: [
				...
				},
				{
					...
					description:
						'Diga adeus às listas de papel e grupos confusos.',
				},
			],
		},
		useCases: {
			...
			subtitle:
				'Não importa o tamanho da sua festa, o PapiFast ajuda você a torná-la inesquecível.',
			items: [
				{
					image: 'https://placehold.co/200x200/orange/white?text=Aniversario',
					title: 'Aniversariantes',
					description:
						'Organize sua festa, envie convites e crie sua lista de presentes em minutos.',
				},
				{
					image: 'https://placehold.co/200x200/222/white?text=Casamento',
					title: 'Noivos',
					description:
						'Gerencie lista de convidados (RSVP) e presentes para o grande dia.',
				},
				{
					image: 'https://placehold.co/200x200/333/white?text=Cha+Bebe',
					title: 'Pais',
					description:
						'Ideal para Chá de Bebê ou Chá Revelação com listas de presentes personalizadas.',
				},
				{
					image: 'https://placehold.co/200x200/444/white?text=Formatura',
					title: 'Formandos',
					description:
						'Organize a turma, venda convites extras e gerencie a entrada no evento.',
				},
			],
		},
		screenshots: {
			...
			items: [
				...
				{
					image: 'https://placehold.co/600x400/555/fff?text=Convites',
					caption: 'Convites Digitais',
				},
				{
					image: 'https://placehold.co/600x400/666/fff?text=Lista+de+Presentes',
		...
		testimonials: {
			...
			subtitle:
				'A experiência de quem já transformou suas festas com o PapiFast.',
			items: [
				{
		...
		businessCta: {
			...
			subtitle:
				'Uma plataforma completa para gestão de eventos, marketing digital e fidelização de clientes.',
			button: 'Conheça Nossa Solução',
			tabs: [
				{
					id: 'gestao',
					title: 'Gestão e Vendas',
					content_title: 'Venda Ingressos',
					content_description:
				...
				},
				{
					...
					content_title: 'Campanhas',
					content_description:
						'Lance campanhas promocionais, crie cardápios digitais interativos com um clique e gere anúncios com IA para impulsionar seus produtos.',
				},
				{
					id: 'fidelizacao',
					title: 'Fidelização',
					content_title: 'Relacionamento',
					content_description:
						'Crie uma base de clientes sólida, envie convites personalizados para eventos exclusivos e utilize vouchers de desconto para incentivar o retorno.',
				},
			],
		},
		contact: {
			...
			description:
				'Crie seu evento no PapiFast agora e aproveite cada momento sem preocupações.',
	...
	businessPage: {
		hero: {
			...
			subtitle:
				'Gestão de eventos, marketing automatizado e vendas integradas. Transforme a experiência do seu cliente e impulsione seus resultados com o PapiFast.',
			...
			items: [
				{
					...
					description:
						'Monetize seus eventos com um sistema de venda de ingressos online.',
				},
				{
					...
					description:
						'Centralize a criação de eventos e o controle de convidados.',
				},
				{
					...
					description:
						'Crie um relacionamento duradouro com seus clientes.',
				},
			],
		},
		infoSections: [
			{
				...
				description:
					'Organize, promova e monetize eventos sem esforço.',
				points: [
			...
			items: [
				{
					...
					description: 'Crie eventos e defina lotes.',
				},
				{
					icon: '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg>',
					title: 'CRM Integrado',
					description: 'Gestão de clientes e equipes.',
				},
			],
		},
		segments: {
			...
			items: [
				{
					...
					title: 'Food Truck',
					description:
						'Gerar Senha de atendimento e cupom no formato gerencial ou fiscal.',
				},
				{
					image: 'https://placehold.co/200x200/222/white?text=Burger',
					title: 'Hamburgueria',
					description:
						'Pedidos de Cliente com controle de pedidos mesa e balcão.',
				},
				{
					image: 'https://placehold.co/200x200/333/white?text=Sorvete',
					title: 'Sorveterias',
					description:
						'Comunicação com balança para peso e ficha para clientes.',
				},
				{
					image: 'https://placehold.co/200x200/444/white?text=Loja',
					title: 'Lojas de Roupas',
					description:
						'Impressão de etiquetas e Leitor de Código de Barras integrado.',
				},
			],
		},
		flowsConfig: {
		...
		flows: [
			{
				...
				steps: [
					{
						title: 'Crie o Evento',
						description: 'Cadastre seu show ou festa.',
					},
					{
						title: 'Venda Ingressos',
						description: 'Defina lotes e preços.',
					},
					{
						title: 'Check-in',
						description: 'Valide na porta com o app.',
					},
		...
		screenshots: {
			...
			items: [
				{
					image: 'https://placehold.co/600x400/222/fff?text=Dashboard+Business',
					caption: 'Dashboard em Tempo Real',
				},
				{
					image: 'https://placehold.co/600x400/333/fff?text=Gestao+Financeira',
					caption: 'Controle Financeiro',
				},
				{
					image: 'https://placehold.co/600x400/444/fff?text=Marketing',
					caption: 'Ferramentas de Marketing',
				},
			],
		},
		testimonials: {
			...
			items: [
				{
					quote: 'O PapiFast transformou a gestão da minha casa de shows.',
					author: 'Carlos, Gerente de Eventos',
				},
				{
					quote: 'Consigo acompanhar as vendas de ingressos de onde estiver.',
					author: 'Fernanda, Produtora',
				},
				{
					quote: 'As ferramentas de marketing automatizado são incríveis.',
					author: 'Ricardo, Dono de Club',
				},
			],
		},
		forClients: {
			...
			description:
				'O PapiFast também é para você. Crie convites, listas de presentes e muito mais.',
			button: 'Conheça a versão para você',
		},
		cta: {
			title: 'Pronto para levar seu negócio ao próximo nível?',
			description:
				'Agende uma demonstração gratuita e descubra como o PapiFast pode transformar a gestão do seu negócio.',
