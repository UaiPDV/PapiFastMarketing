	...
	businessPage: {
		...
		screenshots: {
			...
			items: [
				...
				{
					image: 'img/c2/voucher.png',
					caption: 'Gerenciamento de Vouchers',
				},
			],
		},
		testimonials: {
			...
			items: [
				{
					quote: 'O Wevity transformou a gestão da minha casa de shows.',
		...
		forClients: {
			...
			description:
				'O Wevity também é para você. Crie convites, listas de presentes e muito mais.',
